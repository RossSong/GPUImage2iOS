...
@interface Camera : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
@property (nonatomic) BOOL runBenchmark;
@property (nonatomic) BOOL logFPS;
...
@property (nonatomic, readonly) NSUInteger maximumInputs;
...
@interface UIImage (SWIFT_EXTENSION(GPUImage))
@end
